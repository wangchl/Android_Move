 ...
 * Original file: E:\\AndroidWorkspace\\DevelopArt\\src\\com\\example\\chapter2\\binderpool\\ISecurityCenter.aidl
 */
package com.example.chapter2.binderpool;
public interface ISecurityCenter extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.chapter2.binderpool.ISecurityCenter
{
private static final java.lang.String DESCRIPTOR = "com.example.chapter2.binderpool.ISecurityCenter";
...
/**
 * Cast an IBinder object into an com.example.chapter2.binderpool.ISecurityCenter interface,
 * generating a proxy if needed.
 */
public static com.example.chapter2.binderpool.ISecurityCenter asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.chapter2.binderpool.ISecurityCenter))) {
return ((com.example.chapter2.binderpool.ISecurityCenter)iin);
}
return new com.example.chapter2.binderpool.ISecurityCenter.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.chapter2.binderpool.ISecurityCenter
{
