package com.example.chapter12.loader;
...
public class ImageLoader {
	 ...
	 * imageView and bitmap. NOTE THAT: should run in UI Thread
	 * 
	 * @param uri
	 *            http url
	 * @param imageView
	 *            bitmap's bind object
	 */
	...
	public File getDiskCacheDir(Context context, String uniqueName) {
		boolean externalStorageAvailable = Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED);// 是否安装内存卡
